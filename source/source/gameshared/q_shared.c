...
static short BigShortDetectSwap( short l )
{
    Swap_Init();
    return BigShort( l );
}
static short LittleShortDetectSwap( short l )
{
    Swap_Init();
    return LittleShort( l );
}

static int BigLongDetectSwap( int l )
{
    Swap_Init();
    return BigLong( l );
}
static int LittleLongDetectSwap( int l )
{
    Swap_Init();
    return LittleLong( l );
}

static float BigFloatDetectSwap( float l )
{
    Swap_Init();
    return BigFloat( l );
}
static float LittleFloatDetectSwap( float l )
{
    Swap_Init();
    return LittleFloat( l );
}
